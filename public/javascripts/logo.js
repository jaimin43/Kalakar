...
var copy = "Artistic"; // Text to display

var initSize = Math.floor(Math.random() * .9) + 1  ;
var hoverSize = initSize + .9;
...
function delayedInitRadius() {
    setTimeout(offMouseClick, 1500); //delay for offClick init radius
}
